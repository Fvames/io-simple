...
public class TestBuffer {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("放入后直接取值："+ buf.get()); // 取值为0，实际为存入值
        buf.put(3, 33);    // 放入后position、limit没有增长, 也不能通过get()获取到
        System.out.println(buf.get(4)); //也不能通过get()获取到, 获取到的值为0
        ...
        buf.compact();
        System.out.println("buf对象compact之后为: " + buf);
